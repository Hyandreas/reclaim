"""Seed corpus and demo cases for the local Reclaim backend."""
...
LIVE_CASES = [
    {
        ...
        "route": "deep review",
        "plannerHint": (
            "1 scheduled-maintenance interval has no notice artifact. Billing "
            "history is complete."
        ),
        "intervals": [
            {
                ...
                "notice": "missing",
                "notes": (
                    "Maintenance label present, but no 5-day pre-notice "
    ...
    },
    {
        ...
        "route": "clean",
        "plannerHint": (
            "Unplanned outage tag, complete invoices, no exclusion terms "
            "implicated."
        ),
        "intervals": [
            {
                ...
                "notes": (
                    "Fiber cut confirmed by carrier NOC. No maintenance or "
                    "customer-caused markers."
                ),
            }
        ],
        "invoiceHistory": [],
    ...
    },
    {
        ...
        "plannerHint": (
            "Outage breached SLA, but invoice summary shows a prior June SLA "
            "credit."
        ),
        "intervals": [
            {
                ...
                "notice": "not applicable",
                "notes": (
                    "Access aggregation outage acknowledged by carrier "
                    "incident report."
                ),
            }
        ],
        ...
        "intervals": [
            {
                ...
                "notes": (
                    "Customer approval CRQ-4417 attached. Work completed "
        ...
        "intervals": [
            {
                ...
                "notice": "unclear",
                "notes": (
                    "NOC marks customer power, store log says carrier handoff "
                    "was down."
                ),
            }
        ],
